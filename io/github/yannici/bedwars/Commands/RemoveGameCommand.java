...
public class RemoveGameCommand
  extends BaseCommand
{
  public RemoveGameCommand(Main paramMain)
  {
    super(paramMain);
  }
  ...
  public boolean execute(CommandSender paramCommandSender, ArrayList<String> paramArrayList)
  {
    ...
    Main.getInstance().getGameManager().unloadGame(localGame);
    Main.getInstance().getGameManager().removeGame(localGame);
    paramCommandSender.sendMessage(ChatWriter.pluginMessage(ChatColor.GREEN + Main._l("success.gameremoved")));
    return true;
  }
 ...
 * Qualified Name:     io.github.yannici.bedwars.Commands.RemoveGameCommand
