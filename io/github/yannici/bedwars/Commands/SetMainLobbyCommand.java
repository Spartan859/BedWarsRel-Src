...
public class SetMainLobbyCommand
  ...
  implements ICommand
{
  public SetMainLobbyCommand(Main paramMain)
  {
    super(paramMain);
  }
  ...
  public boolean execute(CommandSender paramCommandSender, ArrayList<String> paramArrayList)
  {
    ...
    localGame.setMainLobby(localPlayer.getLocation());
    localPlayer.sendMessage(ChatWriter.pluginMessage(ChatColor.GREEN + Main._l("success.mainlobbyset")));
    return true;
  }
 ...
 * Qualified Name:     io.github.yannici.bedwars.Commands.SetMainLobbyCommand
