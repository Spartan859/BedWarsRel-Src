  ...
  implements ITNTSheep
{
  ...
  public TNTSheep(net.minecraft.server.v1_8_R3.World paramWorld)
  {
    super(paramWorld);
  }
  ...
  public TNTSheep(Location paramLocation, Player paramPlayer)
  {
    ...
    try
    {
      ...
      getAttributeInstance(GenericAttributes.MOVEMENT_SPEED).setValue(Main.getInstance().getConfig().getDouble("specials.tntsheep.speed", 0.4D));
    }
 ...
 * Qualified Name:     io.github.yannici.bedwars.Com.v1_8_R3.TNTSheep
