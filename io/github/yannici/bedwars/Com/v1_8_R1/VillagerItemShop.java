      ...
      public void run()
      {
        try
        {
          ...
          while (localIterator.hasNext())
          {
            ...
            if ((localVillagerTrade.getHandle().getInstance() instanceof net.minecraft.server.v1_8_R1.MerchantRecipe))
            {
              localObject = (net.minecraft.server.v1_8_R1.MerchantRecipe)localVillagerTrade.getHandle().getInstance();
              ((net.minecraft.server.v1_8_R1.MerchantRecipe)localObject).a(1000);
 ...
 * Qualified Name:     io.github.yannici.bedwars.Com.v1_8_R1.VillagerItemShop
